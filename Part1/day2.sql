...
--Parent tabloda olmayan id ile child tabloya ekleme yapamyıoruz
INSERT INTO adresler VALUES(Null,'Seher sok','31.cad','Izmir');
--Calisanlar id ile adresler tablosundaki adres_id ile eslesmelre bakmak icin

select * from calisanlar,adresler where calisanlar.id=adresler.adres_id;

Drop table calisanlar 
--Parent tabloyu yani primary key olan tabloyu silmek istediğimizde tabloyu
--silmez önce child tabloyu silmemiz gerekir.
